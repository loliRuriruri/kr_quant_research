...
기준 HEAD: `phase-p1-3-job-observability-20260901`
...
인계서 기준 **P0는 P0-6까지 끝났다.** **P1-1 ~ P1-3도 코드에 들어갔다.**
...
1. **P1-4** 백테스트 민감도·표본 경고. 이미 있는 체결 프록시를 과장하지 않게.
2. **P1-5** 시장 국면 점수 재현. 금리·환율·VIX 각각의 날짜와 기여도.
