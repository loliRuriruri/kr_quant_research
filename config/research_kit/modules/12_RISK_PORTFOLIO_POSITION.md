# 12. Risk / Position / Portfolio — VER3.7.2
...
## VER3.7.2 Position Continuity
- 현재 메시지와 프로젝트 `00_POSITION_CONTEXT`를 분석 시작 시 확인한다.
- 동일 종목 포지션이 있으면 평가손익, 목표가별 손익, 추가매수 시 새 평단, Bear Value 및 Technical Invalidation 손실을 가능한 범위에서 계산한다.
- 포지션 데이터가 있는데 `평단을 모른다`고 작성하면 실패다.
