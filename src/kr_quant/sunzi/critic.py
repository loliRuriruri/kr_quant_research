...
POSTURE_HINT = {
    "ENGAGE": "조건은 맞아요. 다만 제가 영웅이 되고 싶어서 그러는 건 아닙니다. 조사 우선순위만 올려 두죠. 출진 명령은, 사양하겠습니다.",
    "WAIT": "회사는 그럭저럭인데, 오늘은 싸울 날이 아니에요. 살아서 차나 식기 전에 마시는 쪽이, 전적보다 중요합니다.",
    "OBSERVE": "관심은 갑니다. 그런데 모르는 채로 움직이는 건, 용기라기보다 사고에 가깝죠. 조금만 더 봅시다.",
    "RETREAT": "이기고 싶은 마음보다 질 이유가 더 선명합니다. 물러나는 것도 전략이에요. 부끄러워할 일 아닙니다.",
    "AVOID": "法이 안 되면 시작하지 않습니다. 그런 싸움에서 이기면, 다음에 더 큰 사고를 치거든요.",
}
...
ASPECT_YANG = [
    {
        ...
        "yang": "연설이 멋있어도 현금이 고개를 저으면, 저는 그 연설을 믿지 않습니다.",
    },
    {
        "id": "tian",
        "han": "天",
        ...
        "yang": "날씨가 궂으면 명장도 막사에서 차를 마시죠. 오늘은 하늘부터 봅시다.",
    },
    {
        "id": "di",
        "han": "地",
        ...
        "yang": "혼자서 잘난 병사보다, 서 있는 언덕이 먼저입니다. 땅은 배신하지 않거든요.",
    },
    {
        "id": "jiang",
        "han": "將",
        ...
        "yang": "용맹한 구호보다, 돈을 어디에 쓰는지가 장수의 실력입니다.",
    },
    {
        "id": "fa",
        "han": "法",
        ...
        "yang": "숫자가 예뻐도 장부가 흔들리면, 그 전쟁은 시작하지 않는 편이 낫습니다.",
    },
]
...
def compose_yang_briefing(
    ...
    if focus_name:
        sunzi_line = f"손자 기준으로 ‘{focus_name}’만 따로 펼쳤습니다. " + sunzi_line
        yang_line = (
            f"‘{focus_name}’이요? 유명해서 본 게 아니라, 싸울 이유가 있는지 보려고 가져왔습니다. "
            + yang_line
        )
    elif scope == "all":
        sunzi_line = "퀀트 상위만이 아니라, 명부에 있는 후보까지 넓혀 세었습니다. " + sunzi_line
        yang_line = "순위 밖의 이름도 전장은 같거든요. 숨은 싸움이 꼭 좋은 싸움은 아닙니다. " + yang_line
    return {
        "title": "양웬리의 오늘 브리핑",
        "sunzi_line": sunzi_line,
        "yang_line": yang_line,
        "voice": "손자가 전장을 세면, 저는 그 숫자로 ‘이 싸움이 필요한가’만 묻습니다. 차부터 식지 않게 하시죠.",
    }
